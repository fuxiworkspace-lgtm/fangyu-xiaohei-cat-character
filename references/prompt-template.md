...
Use the long-scroll master example assets/examples/07-long-scroll-story-master.png as the core template master and quality bar. Preserve its spatial logic and narrative rhythm, not its sample personal facts.
...
Color negative for all modes: no colored mascot redesign, no costume-based character roles, no big expressive eyes, no smiles, no eyebrows, no faction poster, no rainbow character lineup unless the user explicitly asks for a character design sheet, no changing Xiaohei's silhouette or personality by color.
